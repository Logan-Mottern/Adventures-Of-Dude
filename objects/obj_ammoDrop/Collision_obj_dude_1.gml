...
if image_index = 10 obj_menu_main.inv.ammo.En.norm += 3;
if image_index = 11 obj_menu_main.inv.ammo.En.norm += 15;
if image_index = 12 obj_menu_main.inv.ammo.El.norm += 1;
if image_index = 13 obj_menu_main.inv.ammo.El.norm += 3;
if image_index = 14 obj_menu_main.inv.ammo.Pl.norm += 1;
if image_index = 15 obj_menu_main.inv.ammo.Pl.norm += 3;
if image_index = 16 obj_menu_main.inv.ammo.Pl.frag += 1;
if image_index = 17 obj_menu_main.inv.ammo.Pl.frag += 3;
