...
{
	if weaponRand2 = 0 activeWeapon(spr_sh_single,"ammo_Sh_N",0,45,1,3,5,5,1,5,0,0,0,0);
	if weaponRand2 = 1 activeWeapon(spr_sh_light,"ammo_Sh_N",20,135,6,3,8,44,0.5,5,0,0,0,0);
	if weaponRand2 = 2 activeWeapon(spr_sh_heavy,"ammo_Sh_N",30,90,3,5,3,1,1.5,5,0,0,0,0);

}

if (keyboard_check(ord("3")))
{
	if weaponRand3 = 0 activeWeapon(spr_en_light,"ammo_En_N",3,45,30,4,1,2,1,7,0,0,0,0);
}
/*
